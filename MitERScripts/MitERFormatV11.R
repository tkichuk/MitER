...
SummaryFile$Condition[grepl("WTGEtoGE", SummaryFile$Condition)] <- "Respiration"
SummaryFile$Condition[grepl("WTGlutoGE", SummaryFile$Condition)] <- "Transition"
SummaryFile$Condition[grepl("WTGlutoGlu", SummaryFile$Condition)] <- "Fermentation"
SummaryFile$Condition[grepl("TK7GEtoGE", SummaryFile$Condition)] <- "RespirationKO"
SummaryFile$Condition[grepl("TK7GlutoGE", SummaryFile$Condition)] <- "TransitionKO"
SummaryFile$Condition[grepl("TK7GlutoGlu", SummaryFile$Condition)] <- "FermentationKO"

SimpleSummary$Condition <- SimpleSummary$File
SimpleSummary$Condition[grepl("WTGEtoGE", SimpleSummary$Condition)] <- "Respiration"
SimpleSummary$Condition[grepl("WTGlutoGE", SimpleSummary$Condition)] <- "Transition"
SimpleSummary$Condition[grepl("WTGlutoGlu", SimpleSummary$Condition)] <- "Fermentation"
SimpleSummary$Condition[grepl("TK7GEtoGE", SimpleSummary$Condition)] <- "RespirationKO"
SimpleSummary$Condition[grepl("TK7GlutoGE", SimpleSummary$Condition)] <- "TransitionKO"
SimpleSummary$Condition[grepl("TK7GlutoGlu", SimpleSummary$Condition)] <- "FermentationKO"
...
RespirationDistributionFilesMeans<- aggregate(. ~ RespirationDistributionFiles$SectionCellFraction, data = RespirationDistributionFiles[, numeric_cols], FUN = mean)
RespirationDistributionFilesMeans <- cbind("AllFiles", RespirationDistributionFilesMeans [-1], "RespirationFileMeans")
colnames (RespirationDistributionFilesMeans)<-c ("File", "SectionCellFraction", "FractionContactSA", "FractionOutsideContactSA","FractionMitochondrialVolume","FractionOutsideMitochondrialVolume","Condition")
...
FermentationDistributionFilesMeans <- aggregate(. ~ fermentation_subset$SectionCellFraction, data = fermentation_subset[, fermentation_numeric_cols], FUN = mean)
FermentationDistributionFilesMeans <- cbind("AllFiles", FermentationDistributionFilesMeans[-1], "FermentationFileMeans")
colnames (FermentationDistributionFilesMeans)<-c ("File", "SectionCellFraction","FractionContactSA", "FractionOutsideContactSA","FractionMitochondrialVolume","FractionOutsideMitochondrialVolume", "Condition")
...
TransitionDistributionFilesMeans <- aggregate(. ~ transition_subset$SectionCellFraction, data = transition_subset[, transition_numeric_cols], FUN = mean)
TransitionDistributionFilesMeans <- cbind("AllFiles", TransitionDistributionFilesMeans [-1], "TransitionFileMeans")
colnames (TransitionDistributionFilesMeans)<-c ("File", "SectionCellFraction", "FractionContactSA", "FractionOutsideContactSA","FractionMitochondrialVolume","FractionOutsideMitochondrialVolume", "Condition")


OptimalFermTransFraction <- FermentationDistributionFilesMeans[which(max(FermentationDistributionFilesMeans$FractionMitochondrialVolume -TransitionDistributionFilesMeans$FractionMitochondrialVolume)==(FermentationDistributionFilesMeans$FractionMitochondrialVolume -TransitionDistributionFilesMeans$FractionMitochondrialVolume)), "SectionCellFraction"]
OptimalFermRespFraction <- FermentationDistributionFilesMeans[which(max(FermentationDistributionFilesMeans$FractionMitochondrialVolume -RespirationDistributionFilesMeans$FractionMitochondrialVolume)==(FermentationDistributionFilesMeans$FractionMitochondrialVolume -RespirationDistributionFilesMeans$FractionMitochondrialVolume)), "SectionCellFraction"]
OptimalTransRespFraction <- TransitionDistributionFilesMeans[which(max(TransitionDistributionFilesMeans$FractionMitochondrialVolume -RespirationDistributionFilesMeans$FractionMitochondrialVolume)==(TransitionDistributionFilesMeans$FractionMitochondrialVolume -RespirationDistributionFilesMeans$FractionMitochondrialVolume)), "SectionCellFraction"]
